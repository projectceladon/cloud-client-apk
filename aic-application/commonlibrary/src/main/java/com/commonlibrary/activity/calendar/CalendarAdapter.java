...
public class CalendarAdapter extends RecyclerView.Adapter {
    private final int bgColorNormal = Color.WHITE;
    private final int textColorNormal = 0xff7987c8;
    ...
    public int getCurrentMonthPosition() {
        int currentYear = DateTimeUtils.getYear();
        int currentMonth = DateTimeUtils.getMonth();
        return list.indexOf(new CalendarDate(currentYear, currentMonth, 1));
    }
    ...
    public static class SingleSelectColor {
    ...
    public static class AreaSelectColor {
