...
import com.commonlibrary.utils.GalleryUtils;
import com.commonlibrary.utils.LogEx;
import com.commonlibrary.utils.MyBitmapUtils;
...
public class CameraGalleyActivity extends AppCompatActivity implements OnClickListener {
    ...
    public static void gotoCameraCalleyNoCrop(Object parentWrapper, int requestCode) {
        ...
        if (parentWrapper instanceof Activity) {
            ...
            intent.setAction(frg.requireContext().getPackageName() + ".CameraGalleyActivity");
            frg.startActivityForResult(intent, requestCode);
            frg.requireActivity().overridePendingTransition(0, 0);
        }
    }
...
//        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initViewController() {
        btnCamera = findViewById(R.id.btn_camer);
     ...
     * @param outputX      output x
     * @param outputY      output y
     */
