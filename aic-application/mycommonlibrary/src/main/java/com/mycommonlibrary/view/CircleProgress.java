package com.mycommonlibrary.view;
...
public class CircleProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = DensityUtils.dp2px(CircleProgress.DEFAULT_SIZE);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        antiAlias = typedArray.getBoolean(R.styleable.CircleProgressBar_antiAlias, CircleProgress.ANTI_ALIAS);
        ...
        mHintSize = typedArray.getDimension(R.styleable.CircleProgressBar_hintSize, CircleProgress.DEFAULT_HINT_SIZE);

        mValue = typedArray.getFloat(R.styleable.CircleProgressBar_value, CircleProgress.DEFAULT_VALUE);//50
        mMaxValue = typedArray.getFloat(R.styleable.CircleProgressBar_maxValue, CircleProgress.DEFAULT_MAX_VALUE);//100
        ...
        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, CircleProgress.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.CircleProgressBar_unitSize, CircleProgress.DEFAULT_UNIT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_arcWidth, CircleProgress.DEFAULT_ARC_WIDTH);
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgressBar_startAngle, CircleProgress.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle, CircleProgress.DEFAULT_SWEEP_ANGLE);

        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, Color.WHITE);
        mBgArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgArcWidth, CircleProgress.DEFAULT_ARC_WIDTH);//圆弧宽度(一般和背景圆弧宽度相等)
...
//        mPercent = typedArray.getFloat(R.styleable.CircleProgressBar_percent, 0);
        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, CircleProgress.DEFAULT_ANIM_TIME);
