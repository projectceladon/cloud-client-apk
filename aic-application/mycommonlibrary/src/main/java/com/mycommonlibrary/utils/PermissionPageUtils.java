...
public class PermissionPageUtils {
    ...
    //自己的项目包名
    //private String packageName = PackageUtils.getPackageName(MyApp.context);

    public PermissionPageUtils(Context context, String packageName) {
    ...
    public void jumpPermissionPage() {
        ...
        switch (name) {
            ...
            case "Coolpad":
                ...
                break;
            case "Meizu":
                goMeizuMainager(packageName);
                break;
            case "Xiaomi":
                goXiaoMiMainager(packageName);
                break;
            case "samsung":
                goSangXinMainager();
                break;
            case "Sony":
                goSonyMainager(packageName);
                break;
            case "LG":
                goLGMainager(packageName);
                break;
            default:
                goIntentSetting();
                break;
    ...
    private void goLGMainager(String packageName) {
        try {
    ...
    private void goSonyMainager(String packageName) {
        try {
            Intent intent = new Intent(packageName);
    ...
    private void goHuaWeiMainager(String packageName) {
        try {
            Intent intent = new Intent(packageName);
    ...
    private void goXiaoMiMainager(String packageName) {
    ...
    private void goMeizuMainager(String packageName) {
        try {
