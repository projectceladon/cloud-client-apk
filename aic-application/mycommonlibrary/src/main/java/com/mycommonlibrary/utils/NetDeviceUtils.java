...
public class NetDeviceUtils {
    ...
    public static String getWifiInformation() {
        ...
        builder.append("HiddenSSID=" + info.getHiddenSSID() + "\n");
        builder.append("IpAddress=" + formatIP4(info.getIpAddress()) + "\n");
        builder.append("LinkSpeed=" + info.getLinkSpeed() + "\n");
        builder.append("NetworkId=" + info.getNetworkId() + "\n");
        builder.append("Rssi=" + info.getRssi() + "\n");
        builder.append("SSID=" + info.getSSID() + "\n");
        builder.append("MacAddress=" + info.getMacAddress() + "\n");
