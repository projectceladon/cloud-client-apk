...
public class KeyConst {
    ...
    public static final int VK_DPAD_LEFT = 14;
    public static final int VK_UP = 0x26;
    public static final int VK_DPAD_UP = 12;
    public static final int VK_RIGHT = 0x27;
    public static final int VK_DPAD_RIGHT = 15;
    public static final int VK_DOWN = 0x28;
    public static final int VK_DPAD_DOWN = 13;
    /**
    ...
    public static final int VK_DPAD_A = 0;
    public static final int VK_B = 0x42;
    public static final int VK_DPAD_B = 1;
    ...
    public static final int VK_DPAD_X = 2;
    public static final int VK_Y = 0x59;
    public static final int VK_DPAD_Y = 3;
    public static final int VK_Z = 0x5A;
    public static final int VK_DPAD_L1 = 4;
    public static final int VK_DPAD_L2 = 6;
    public static final int VK_DPAD_R1 = 5;
    public static final int VK_DPAD_R2 = 7;
    public static final int VK_DPAD_SELECT = 8;
    public static final int VK_DPAD_START = 9;
    /**
