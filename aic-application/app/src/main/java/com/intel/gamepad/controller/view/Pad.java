...
public class Pad extends View {
    ...
    public void setDrawPartitionAll(boolean drawAll) {
        drawPartitionAll = drawAll;
    }

    public void setDrawPartitionLine(int[] draw) {
        drawPartitionLine = draw;
    }
    ...
    public void setColorPad(int color) {
        colorPad = color;
    }

    public void setColorPadLine(int color) {
        colorPadLine = color;
    }

    public void setColorHotspot(int color) {
        colorHotspot = color;
    }
